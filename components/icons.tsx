...
export const CloudIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M17.5 16c2.5 0 4.5-2 4.5-4.5S20 7 17.5 7c-.2 0-.4 0-.6.1-.9-3.2-3.8-5.6-7.2-5.6-3.8 0-6.9 2.8-7.4 6.5-.2 0-.4-.1-.6-.1C4.5 7.9 2.5 9.9 2.5 12.4S4.5 16.9 7 16.9h10.5z" />
  </svg>
);
